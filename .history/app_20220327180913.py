...
with col1:
    ...
    info = st.markdown('By submitting this form, you agree to share your data with Family  NGO partners as well as [INSERT]s cookie policy. You consent to receive communications from [INSERT]. If you want to unsubscribe, contact us on [INSERT email].')
