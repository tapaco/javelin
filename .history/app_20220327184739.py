...
st.markdown('To assist with the Homes For Ukraine scheme, the High Wycombe Ukrainian community is matching Ukrainians with hosts in South East England, through our contacts with family, friends and local NGOs on the ground in Ukraine. Please fill out the form below and we will be in touch once a match is made for introductions. Any questions please contact us on contact@familiesforukraine.co.uk')
st.markdown('---')
...
with col1:
    ...
    info = st.markdown("By submitting this form, you agree to share your data with Families for Ukraine's NGO partners as well as our cookie policy. You consent to receive communications from Families For Ukraine. If you want to unsubscribe, contact us on info@familiesforukraine.co.uk.")
...
if submit:
    try: 
        ...
        st.error('There has been an error with submitting your form, please try another email address or contact info@familiesforukraine.co.uk')
