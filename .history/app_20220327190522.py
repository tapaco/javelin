...
with col1:
    ...
    info = st.markdown("By submitting this form, you agree to share your data with Families for Ukraine's NGO partners as well as our cookie policy. You consent to receive communications from Families For Ukraine. If you want to unsubscribe, email contact@familiesforukraine.co.uk.")
