...
with col1:
    ...
    info = st.markdown("By submitting this form, you agree to share your data with Families for Ukraine's NGO partners and our cookie policy. You consent to receive communications from Families For Ukraine. If you wish to withdraw, contact contact@familiesforukraine.co.uk")
