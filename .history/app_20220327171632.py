...
with col1:
    ...
    photos = st.file_uploader('Add photo of your room') 
    other = st.text_input('Other information about you')
    info = st.markdown('###### By submitting this form, you agree to share your personal data with [INSERT] NGO partners as well as [INSERT]s cookie policy. You consent to receive communications from [INSERT]. If you want to unsubscribe, contact us on [INSERT email].')
